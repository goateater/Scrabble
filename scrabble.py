...
def isValidWord(word, hand, wordList):
    ...
    for letter in freqDict.keys():
        if letter not in hand.keys() or hand[letter] < freqDict[letter]:
            return False
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        word = raw_input("Enter word, or a '.' to indicate that you are finished: ").lower()# Ask user for input
        ...
        if word == '.':    # If the input is a single period:
            ...
            #print ('"' + word + '" earned ' + str(wordScore) + ' points. ' + ' Total: ' + str(wordScore) + ' points. ' + ' Total: ' + str(score) + ' points')
